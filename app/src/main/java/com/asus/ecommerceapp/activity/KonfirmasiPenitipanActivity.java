...
public class KonfirmasiPenitipanActivity extends AppCompatActivity {
    ...
    private String UPLOAD_URL = "http://pawspetstore.xyz/API/KonfirmasiPenitipan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konfirmasi_penitipan);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(KonfirmasiPenitipanActivity.this, "Error Mas Bro", Toast.LENGTH_LONG).show();
