...
public class HistoryGroomingViewHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.ll_jenis) LinearLayout llJenis;
    ...
    public HistoryGroomingViewHolder(@NonNull View itemView) {
        super(itemView);
